...
namespace MEA2100_Recording_and_Stimulation
{
    static class Program
    {
        ...
        static void Main()
        {
            Console.WriteLine("Initializing MCS device...");
            InitializeMCSDevice();
        ...
        {
            // Replace the IsConnected property with a check that works with your version
            Console.WriteLine($"Device event: {entry}");
        }
